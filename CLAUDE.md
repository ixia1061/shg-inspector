...
app/
  ...
  (admin)/                 관리자 (사이드바 레이아웃, role=admin/super_admin 가드)
    ...
    labels/                QR 일괄 출력 (검색·다중선택·일괄 인쇄, force-dynamic)
