        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              ...
              만 보고 관리합니다. <b>사업장 전체를 담당하면 그 사업장의 관리파트도 추가·수정</b>할 수
              있습니다. 사업장 자체의 등록·수정·삭제는 시스템관리자 전용입니다.
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li><b>사업장/건물 관리</b>: 관리파트·건물·층·차량 등록/수정 (사업장 자체 추가는 시스템관리자)</li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li><b>관리파트</b> 추가/수정은 그 사업장 전체를 담당하는 관리자와 시스템관리자가 할 수 있습니다(사업장 자체는 시스템관리자만). 파트 코드를 바꾸면 소속 소화기 관리번호가 재계산되니 <b>QR 재출력</b> 안내를 확인하세요.</li>
          </ul>
        </CardContent>
      </Card>
