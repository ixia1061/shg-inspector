  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li><b>점검현황</b>: 미점검/조치필요/조치완료/점검완료, 건물별 점검률, 관리대장(엑셀) 다운로드</li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            <li><b>관리파트</b>: 사업장 안에서 소화기를 나눠 관리하는 단위로, <b>관리번호 앞자리</b>가 됩니다(예: 공사-1-1-1). 소화기 등록 시 파트를 선택합니다.</li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          ...
          <ul className="mt-1 ml-4 flex list-disc flex-col gap-1">
            <li><b>관리파트</b> 선택: 관리번호 앞자리가 됩니다(예: 공사-1-1-1)</li>
      ...
      <Card>
        <CardHeader>
          <CardTitle>점검자 배정 (관리파트별 점검 권한)</CardTitle>
        </CardHeader>
        <CardContent className="text-sm">
          <b>점검자 배정</b>에서 점검자 × 관리파트 체크박스로 점검 권한을 부여/해제합니다. 부여된
          파트의 소화기만 그 점검자가 스캔·점검할 수 있습니다. 관리자는 <b>자기 담당 범위의 파트만</b>{" "}
          부여할 수 있습니다.
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              신청이 들어오면 <b>사용자 관리 → 가입 승인 대기</b>에 나타납니다. <b>승인</b>을 누르면
              그 <b>사업장 전체</b>를 점검할 수 있게 되고, 그때부터 로그인·점검이 가능합니다.
            </li>
            <li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li><b>점검자가 "권한이 없다"고 함</b>: <b>점검자 배정</b>에서 해당 파트 점검 권한을 켜 주세요.</li>
          </ul>
        </CardContent>
      </Card>
    </>
