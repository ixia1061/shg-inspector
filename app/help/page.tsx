    ...
    <>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              버튼 왼쪽 <b>월 선택</b>에서 <b>지난달</b>을 고르면 그 달 기준 대장을 받습니다(그 달의
              점검일·O/X·불량내용·조치내용). <b>현재 상태</b>는 가장 최근 점검 기준입니다 — 새 달에
              점검이 시작되면 지난달 내용은 이 대장에서 빠지므로, 지난 기록은 월을 골라 받으세요.
            </li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          ...
          보이고, 시스템관리자가 &quot;사업장 전체&quot;로 배정한 곳은 <b>전체 배정됨</b>으로 잠겨
          있습니다.
        </CardContent>
      </Card>
