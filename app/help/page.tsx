    ...
    <>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ol className="ml-4 flex list-decimal flex-col gap-1">
            ...
            <li>
              가입코드·이름·<b>소속</b>·이메일·비밀번호를 입력하고 <b>[가입 신청]</b>. 소속은
              관리자가 점검할 구역을 정할 때 참고하므로 <b>소속 회사·부서</b>를 적어주세요
              (예: 한국공항공사).
            </li>
            <li>
      ...
      <Card>
        ...
        <CardContent className="text-muted-foreground text-sm">
          <b>비밀번호를 잊었다면</b> 담당 관리자에게 말씀하세요 — <b>임시 비밀번호</b>를 발급해
          줍니다. 그 값으로 로그인한 뒤 <b>내 계정</b>에서 원하는 비밀번호로 바꾸면 됩니다. 그 밖의
          문제는 사용 기기·화면 이름·<b>관리번호</b>·오류 메시지·발생 시각을 정리해 관리자에게
          문의하세요.
        </CardContent>
      </Card>
    </>
  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            <li><b>대시보드</b>: 이번 달 점검·미점검, 조치 필요, 교체예정·만료 요약 (조치 필요 카드 → 이상점검 화면)</li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              <b>조치 필요</b>: 최근 점검이 <b>이상</b>인데 아직 조치하지 않은 소화기 수입니다.
              달이 바뀌어도 <b>조치를 마칠 때까지 남습니다.</b> 카드를 누르면{" "}
              <b>이상점검</b> 화면이 열려 어떤 소화기가 왜 이상인지, 지난 달까지의 이력이 어떤지
              모두 볼 수 있습니다.
            </li>
            <li><b>건물별 점검률</b>: 담당 사업장의 건물별 이번 달 점검 진행률.</li>
            <li>
              <b>카드를 누르면 그 목록으로 이동합니다.</b> 총 소화기 → 소화기 관리, 점검완료·미점검
              → 점검현황(해당 탭), 조치 필요 → 이상점검, 교체예정·만료 → 내용연수 관리.
              <b>보고 있던 사업장이 그대로 이어집니다.</b>
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              <b>조치필요 탭만 달로 자르지 않습니다.</b> 조치를 마칠 때까지 남으므로 지난달에 난
              이상도 계속 보입니다(이번달에 아직 점검하지 않았다면 미점검 목록에도 함께 나옵니다).
            </li>
            <li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            ...
            <li>
              내 코드로 신청이 들어오면 <b>사용자 관리 → 가입 승인 대기</b>에 나타납니다. 목록의{" "}
              <b>소속</b>(신청자가 직접 적은 값)을 보고 어느 팀 사람인지 확인한 뒤,
              <b>승인</b>을 누르고 <b>점검할 사업장을 체크</b>하면 그때부터 로그인·점검이 가능합니다.
              담당 사업장이 하나뿐이면 자동으로 체크됩니다. <b>내가 담당하는 사업장을 모두 포함하는
              하위 관리자의 신청</b>도 함께 보이므로, 전체 사업장을 맡은 관리자는 아래 관리자들의
              신청까지 처리할 수 있습니다.
            </li>
            <li>
            ...
            <li>
              점검자가 <b>비밀번호를 잊었다면</b> <b>[비밀번호]</b> 버튼으로 임시 비밀번호를
              발급합니다. 화면에 <b>한 번만</b> 보이니 복사해 전달하고, 받은 사람은 로그인 후{" "}
              <b>내 계정</b>에서 바꾸면 됩니다.
            </li>
            <li>
            ...
            <li>
              <b>소속</b>은 사용자 관리 목록의 소속 칸 옆 <b>연필 아이콘</b>으로 언제든 고칠 수
              있습니다(오타·부서 이동). 표시용 값이라 <b>권한에는 영향을 주지 않습니다</b> —
              점검 범위는 <b>[범위 변경]</b>으로 따로 정합니다.
            </li>
      ...
      <Card>
        ...
        <CardContent className="text-sm">
          <ul className="ml-4 flex list-disc flex-col gap-1">
            <li><b>로그인 실패</b>: 이메일·비밀번호 확인. 점검자 계정 문제는 사용자 관리에서 상태(활성) 확인. 비밀번호를 잊었다면 <b>[비밀번호]</b> 로 임시 비밀번호 발급.</li>
